...
public struct AlertToast: View {
    ...
    public var hud: some View {
        ...
        HStack {
            Group {
                HStack(spacing: 16) {
                    ...
                    if title != nil || subTitle != nil {
                        VStack(alignment: type == .regular ? .leading : .leading, spacing: 2) {
                            if title != nil {
                                Text(LocalizedStringKey(title ?? ""))
            ...
            // Distance of hud from the top
            .padding(.top, 5)
            
        }
        // Distance of hud from the leading AND  trainling
...
/*
.toast(isPresenting: $showToast, duration: 4, tapToDismiss:true, offsetY: 10) {
    /*
    AlertToast(displayMode: .banner(.pop), type: .regular, title: "qwertyu", subTitle: "shvywghsdfirufhedkcjwsios dfu ghvjfoifk", style:.style(backgroundColor: .red, titleColor: .white, subTitleColor: .white, titleFont: .callout, subTitleFont: .subheadline) )
     */
    
    // MARK: Alert
    AlertToast(displayMode: .alert, type: .loading, title: "qwertyui", subTitle: "rwfdfbjcs fvgvnui djvsfycuvfdi jnBackgroundModifieras fvfb ",style:.style(backgroundColor: .red, titleColor: .white, subTitleColor: .white, titleFont: .callout, subTitleFont: .subheadline))
     
    // MARK: Hud
     /*   AlertToast(displayMode: .hud, type: .regular,title: "DatafDatafoundDatafou", subTitle: "Please Try agai",style:.style(backgroundColor: .red, titleColor: .white, subTitleColor: .white, titleFont: .largeTitle, subTitleFont: .subheadline))
      */
} onTap: {
   print("onTap")
} completion: {
